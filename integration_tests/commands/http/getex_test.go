...
func TestGetEx(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expected:   []interface{}{"OK", "bar", "-1", "bar", float64(2), nil, "-2"},
		...
		},
		{
			...
			expected:   []interface{}{"OK", "bar", "-1", "bar", float64(5), nil, "-2"},
			assertType: []string{"equal", "equal", "equal", "equal", "assert", "equal", "equal"},
		...
		},
		{
			...
			expected:   []interface{}{"OK", "bar", "-1", "bar", float64(10), nil, "-2"},
			assertType: []string{"equal", "equal", "equal", "equal", "assert", "equal", "equal"},
		...
		},
		{
			...
			expected:   []interface{}{"OK", float64(10), "bar", "-1"},
