...
func TestHSCAN(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expect: []interface{}{int64(2), []interface{}{"0", []interface{}{"field1", "value1", "field2", "value2"}}},
			delays: []time.Duration{0, 0},
		},
		{
			name:   "HSCAN with cursor at the end",
			cmds:   []string{"HSET key_hScan1 field1 value1 field2 value2", "HSCAN key_hScan1 2"},
			expect: []interface{}{int64(2), []interface{}{"0", []interface{}{}}},
			delays: []time.Duration{0, 0},
		},
		{
		...
		},
		{
			...
			expect: []interface{}{int64(2), []interface{}{"0", []interface{}{"field2", "value2"}}},
			delays: []time.Duration{0, 0},
		},
		{
			...
			expect: []interface{}{int64(3), []interface{}{"0", []interface{}{"field1", "value1", "field2", "value2"}}},
			delays: []time.Duration{0, 0},
		},
		{
			...
			expect: []interface{}{int64(3), []interface{}{"2", []interface{}{"field1", "value1", "field2", "value2"}}},
			delays: []time.Duration{0, 0},
		},
		{
			...
			expect: []interface{}{int64(4), []interface{}{"1", []interface{}{"field1", "value1"}}},
			delays: []time.Duration{0, 0},
		},
		{
			...
			expect: []interface{}{int64(2), "ERR Invalid glob pattern: unexpected end of input"},
			delays: []time.Duration{0, 0},
		},
		{
			...
			expect: []interface{}{int64(2), "ERR value is not an integer or out of range"},
			delays: []time.Duration{0, 0},
		},
	}
