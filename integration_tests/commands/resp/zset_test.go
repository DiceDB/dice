...
func TestZADD(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			FireCommand(conn, "DEL key") // Resetting the key before each test
...
func TestZRANGE(t *testing.T) {
	...
	testCases := []TestCase{
		...
		},
		{
			...
			expected: []interface{}{int64(4), []interface{}{}, []interface{}{}, []interface{}{"Bob", "Dave"}, []interface{}{"Bob"}},
		},
		{
			...
			expected: []interface{}{int64(0), []interface{}{"Dave", "80", "Bob", "70", "Charlie", "60", "Alice", "50"}, []interface{}{"Alice", "Charlie"}},
		},
	}
