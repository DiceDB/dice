...
type WALLogEntry struct {
	...
	Checksum string `protobuf:"bytes,1,opt,name=checksum,proto3" json:"checksum,omitempty"` // SHA-256 checksum of the command for integrity
...
func (x *WALLogEntry) GetChecksum() string {
	if x != nil {
		return x.Checksum
	}
	return ""
